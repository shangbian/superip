...
// 所有智能体的原始数据
const allAgentsMap = {
    1: { id: 1, name: '7天选题', description: '一键产出每周选题清单，助力账号持续增长', fullDescription: '功能定义：输入账号定位，一键产出每周选题清单，保障内容高质量产出与账号增长。\n使用场景：每周内容策划时，快速产出兼具吸引力和商业价值的选题清单。\n核心价值：解决"拍什么"的难题，系统化保障内容质量与数量，维持账号活跃度与粉丝增长。', inputGuide: '请提供你的行业与核心产品信息（按以下格式），加上日期（可选）\n→ [行业类型]店/公司 + [核心产品/服务]\n例如：少儿编程培训（ToC教育服务）', welcomeMessage: '输入日期，一键生成一周的选题：比如：2026年4月1日。回复任意内容可生成自定义账号选题。', suggestedPrompts: ['2026年3月17日', '帮我生成下周选题', '企业服务行业+商机平台'], functionDef: '自动生成一周的高效视频选题，涵盖吸引粉丝、建立人设和促进转化三类目标。' },
    2: { id: 2, name: '内容仿写', description: '套用爆款框架，一键创作风格融合文案', fullDescription: '功能定义：将客户喜欢的内容（A）转化为（B）爆款框架进行表达。\n使用场景：知识型、技术型、服务型企业创作科普类、教学类爆款短视频内容。\n核心价值：降低创作门槛，让小白也能做出爆款，同时解决抄袭举报问题。', inputGuide: '第1次先发A文案，核心主题或信息，第2次再发B文案，按照a的内容+ B的结构，创造出全新的文案。', welcomeMessage: '第 1 次：发A文案【主题/脚本均可】；第2次：发 B文案【爆款内容】，将按B的爆款风格修改A文案。', suggestedPrompts: ['生成行业内独特、前沿或反常识的观点与洞察'], functionDef: '将客户喜欢的内容（A）转化为（B）爆款框架进行表达。' },
    3: { id: 3, name: '爆款改写', description: '输入爆款文案，一键多风格改写翻新', fullDescription: '功能定义：对同行千万级大爆款文案或视频脚本进行多风格、多角度的高效重写与优化。\n使用场景：一条爆款视频需生成多个版本以测试效果，或旧内容需要翻新再次发布。\n核心价值：极大提升内容复用效率，实现"一鱼多吃"，持续挖掘单个选题的流量潜力。', inputGuide: '输入短视频文案，生成深度原创且风格高度相似的文案。', welcomeMessage: '粘贴爆款脚本，生成内容相近的原创脚本，规避搬运/抄袭违规。', suggestedPrompts: ['帮我翻新一条旧视频文案', '我要改写同行爆款'], functionDef: '对同行千万级大爆款文案或视频脚本进行多风格、多角度的高效重写与优化。' },
    4: { id: 4, name: '热点二创', description: '输入热点事件，快速生成借势爆款脚本', fullDescription: '功能定义：输入实时热点关键词或扒皮文案，生成与人群相关的热点借势视频创意。\n使用场景：需要快速响应网络热点，获取短期流量爆发时，解决热点抓不住的问题。\n核心价值：抓住流量红利，低成本获取高曝光，为账号注入爆发性流量。', inputGuide: '输入热点事件相关信息，生成文案', welcomeMessage: '发送热点关键词 / 相关素材，生成匹配目标人群的热点借势文案。', suggestedPrompts: ['DeepSeek发布新模型引发关注', '帮我改写一条热点新闻', '小米汽车新款发布引爆全网'], functionDef: '输入实时热点关键词或扒皮文案，生成与人群相关的热点借势视频创意。' },
    5: { id: 5, name: '大字报（自我介绍）', description: '一键生成企业家成长感悟爆款文案', fullDescription: '功能定义：挖掘与目标用户息息相关的长期性话题，生成内容创作方向。\n使用场景：规划非热点类的常规视频内容，确保内容始终贴近用户兴趣。\n核心价值：保障账号基础流量，建立稳定的内容体系，强化用户粘性。', inputGuide: '输入1，直接生成【自我反思与成长】的爆款文案', welcomeMessage: '发送“1”回复人设信息，生成大字报文字。', suggestedPrompts: ['1', '帮我生成情感共鸣类文案', '企业家自我成长故事'], functionDef: '用于生成短视频中自我介绍大字报内容文案与视觉提示。' },
    6: { id: 6, name: '大字报（行业类）', description: '行业视角大字报图文文案一键生成', fullDescription: '功能定义：专门用于生成短视频中的图文类（大字报）内容文案与视觉提示。\n使用场景：制作信息密度高、观点冲击力强的图文视频或视频中的文字贴片。\n核心价值：在3秒内抓住用户注意力，提升视频完播率，适合传递核心观点和卖点。', inputGuide: '输入以下信息：\n核心行业/领域：(例如：美容美体)\n核心产品/服务名称或类型：(例如：纹绣技术)\n希望在首行突出的"形容词/核心卖点短语"：(请提供1-3个备选)\n产品/服务的主要优势、功能特点、能解决的用户痛点：(请列举至少3-5项)\n目标用户群体画像或主要适用场景：\n可选：希望加入的行动号召或相关话题标签：', welcomeMessage: '发送行业及形容词（描述卖点/优势等）即可产出文案内容。', suggestedPrompts: ['教培行业+专业+家长群体', '美容美体行业+高端+爱美女性', '企业服务行业+精准+老板群体'], functionDef: '用于生成项目行业亮点的短视频视觉提示文案或大字报视频文案。' },
    7: { id: 7, name: '大字报（惊喜类）', description: '万万没想到惊喜风格大字报一键生成', fullDescription: '功能定义：专门用于生成短视频中的图文类（大字报）内容文案与视觉提示。\n使用场景：制作信息密度高、观点冲击力强的图文视频或视频中的文字贴片。\n核心价值：在3秒内抓住用户注意力，提升视频完播率，适合传递核心观点和卖点。', inputGuide: '输入以下信息进行创作：\n核心体验/产品/服务：\n"万万没想到"的具体惊喜点/超预期效果：(这是文案的灵魂，请详细描述)\n希望引发的情感或用户反应：\n可选：目标用户群体希望触达的痛点：\n可选：希望加入的行动号召或相关话题标签：', welcomeMessage: '输入“1”生成天九大会相关内容示例；或提供产品/体验与惊喜点，生成专属文案。', suggestedPrompts: ['1', '2', '帮我生成惊喜类大字报'], functionDef: '用于生成强烈惊喜开头，突出意想不到的效果的大字报或视频贴片文案。' },
    8: { id: 8, name: '大字报（发现类）', description: '发现新奇事物报道图文文案一键生成', fullDescription: '功能定义：专门用于生成短视频中的图文类（大字报）内容文案与视觉提示。\n使用场景：制作信息密度高、观点冲击力强的图文视频或视频中的文字贴片。\n核心价值：在3秒内抓住用户注意力，提升视频完播率，适合传递核心观点和卖点。', inputGuide: '输入以下信息进行创作：\n具体地点名称（什么地方）：\n出现的新奇事物/现象/创新模式（什么东西）：\n"意外转折/影响"的具体内容：\n"用户/顾客反馈"的核心内容：\n"大众/网友呼吁/热议"的核心内容：', welcomeMessage: '输入“1”按要求提供信息，快速生成爆款文案。', suggestedPrompts: ['北京出现了AI自习室', '上海发现无人驾驶洗车场'], functionDef: '用于生成【什么地方出现什么东西】大字报或视频贴片文案。' },
    9: { id: 9, name: '痛点共鸣', description: '企业家痛点与情感共鸣类爆款文案', fullDescription: '功能定义：专门用于生成短视频中的图文类（大字报）内容文案与视觉提示。\n使用场景：制作信息密度高、观点冲击力强的图文视频或视频中的文字贴片。\n核心价值：在3秒内抓住用户注意力，提升视频完播率，适合传递核心观点和卖点。', inputGuide: '输入 1：直接生成企业家痛点与情感共鸣类爆款文案。\n如需更贴合你的情况，可补充：姓名、所在地、行业、从业年限、业务规模等信息后发送。', welcomeMessage: '发送“1”，生成引发客户共鸣的内容。', suggestedPrompts: ['1', '我是教育行业做了15年', '企业家成长痛点'], functionDef: '挖掘与企业家成长相关话题，生成企业家痛点与情感共鸣类内容。' },
    10: { id: 10, name: '吸粉类口播（千万不要开头）', description: '输入主题生成「千万不要」口播脚本', fullDescription: '功能定义：生成短视频的打粉型口播脚本，旨在瞬间抓住用户注意力并完成吸粉。\n使用场景：为任何视频创作高效的开头与中间和结尾，完成4大数据指标。\n核心价值：提升视频的4个关键流量指标，是视频能否拿到海量客资的关键。', inputGuide: '把一条脚本内容发给我，改写成千万不要开头风格的吸粉口播文案。', welcomeMessage: '发送你的脚本，将其改写为以「千万不要」开头的文案', suggestedPrompts: ['千万不要在这个行业轻易入局', '帮我仿写一条口播文案'], functionDef: '用于生成「千万不要」句式钩子吸粉类型口播脚本。' },
    11: { id: 11, name: '吸粉口播（你敢信开头）', description: '输入主题生成「你敢相信吗」口播脚本', fullDescription: '功能定义：生成短视频的打粉型口播脚本，旨在瞬间抓住用户注意力并完成吸粉。\n使用场景：为任何视频创作高效的开头与中间和结尾，完成4大数据指标。\n核心价值：提升视频的4个关键流量指标，是视频能否拿到海量客资的关键。', inputGuide: '输入爆款文案进行改写创作：', welcomeMessage: '发送你的脚本，将其改写为以「你敢信么」开头的文案。', suggestedPrompts: ['你敢信，我一条视频涨粉5万', '帮我生成一条口播开头'], functionDef: '用于生成「你敢相信吗」钩子吸粉类型口播脚本。' },
    12: { id: 12, name: '吸粉类口播脚本（你知道吗开头）', description: '输入主题生成「你知道有多牛」口播', fullDescription: '功能定义：生成短视频的打粉型口播脚本，旨在瞬间抓住用户注意力并完成吸粉。\n使用场景：为任何视频创作高效的开头与中间和结尾，完成4大数据指标。\n核心价值：提升视频的4个关键流量指标，是视频能否拿到海量客资的关键。', inputGuide: '输入爆款文案进行改写创作：', welcomeMessage: '发送你的脚本，将其改写为以「你知道吗」开头的文案。', suggestedPrompts: ['你知道企业合作有多牛吗', '帮我仿写一条口播'], functionDef: '用于生成「你知道什么有多牛吗」钩子吸粉类型脚本。' },
    13: { id: 13, name: '吸粉类口播脚本（马上大爆发开头）', description: '输入主题生成「马上大爆发」口播脚本', fullDescription: '功能定义：生成短视频的打粉型口播脚本，旨在瞬间抓住用户注意力并完成吸粉。\n使用场景：为任何视频创作高效的开头与中间和结尾，完成4大数据指标。\n核心价值：提升视频的4个关键流量指标，是视频能否拿到海量客资的关键。', inputGuide: '输入爆款文案进行改写创作：', welcomeMessage: '发送你的脚本，将其改写为以「XX迎来爆发」为钩子的文案。', suggestedPrompts: ['企业服务行业马上迎来大爆发', '帮我仿写一条钩子口播'], functionDef: '用于生成「从现在开始，某产品/平台名马上迎来大爆发」类吸粉口播脚本。' },
    14: { id: 14, name: '视频标题', description: '输入文案一键生成标题与评论区引导语', fullDescription: '功能定义：自动生成短视频的标题、描述、评论区引导语等配套文案。\n使用场景：视频剪辑完成后，快速撰写能提升点击率、互动率和转化率的文案。\n核心价值：完善视频发布细节，提升算法推荐概率，引导用户完成点赞、评论、私信等动作。', inputGuide: '输入原文案', welcomeMessage: '发送视频脚本正文，生成标题、描述、评论区引导等 9 类配套文案。', suggestedPrompts: ['帮我生成5个爆款标题', '视频主题：企业转型'], functionDef: '自动生成短视频的标题、描述、评论区引导语等配套文案。' },
    15: { id: 15, name: '专业观点', description: '一键生成震撼洞察观点，打造专家IP形象', fullDescription: '功能定义：生成行业内独特、前沿或反常识的观点与洞察。\n使用场景：打造专家、创始人IP，需要输出震撼观点树立行业权威时。\n核心价值：通过信息差建立品牌心智，吸引高质量用户关注，实现"心智捕鱼"。', inputGuide: '回复 1：生成 10 种风格的专业观点供你选择。\n回复 2：按我提供的信息清单填写后，定制生成专属专业观点。', welcomeMessage: '发送“1”：生成 10 种风格专业观点供选择；再回复“2”，生成对应内容分享语', suggestedPrompts: ['1', '2', '企业转型商业洞察'], functionDef: '生成行业内独特、前沿或反常识的观点与洞察。' },
    16: { id: 16, name: '观点金句', description: '将观点提炼成金句，强化内容记忆点', fullDescription: '功能定义：将复杂观点浓缩成一句朗朗上口、易于传播的金句或口号。\n使用场景：用于视频标题、结尾slogan、评论区互动，强化品牌记忆点。\n核心价值：降低传播成本，一句话让用户记住你，提升品牌影响力。', inputGuide: '输入一个观点或概念', welcomeMessage: '输入观点/故事等内容，为其生成金句/口号文案。', suggestedPrompts: ['1', '企业合作共赢的核心价值', '帮我把观点变成金句'], functionDef: '将复杂观点浓缩成一句朗朗上口、易于传播的金句或口号。' },
    17: { id: 17, name: '客户故事', description: '将客户案例转化为故事化视频，驱动转化', fullDescription: '功能定义：将客户成功案例转化为富有感染力的故事化叙述脚本。\n使用场景：创作客户见证、成果展示类视频，用事实说服潜在客户。\n核心价值：提供最强社会证明，有效打消用户疑虑，直接推动成交转化。', inputGuide: '输入1直接生成\n或用户提供一个真实案例的基本信息，包括：\n- 客户背景/行业\n- 初始问题/痛点\n- 采取的解决方案\n- 取得的具体成果\n- (可选)客户反馈或感言', welcomeMessage: '发送“1”生成案例；【首次】输入“2”按问题清单提供信息，生成对应案例。', suggestedPrompts: ['1', '2', '分享一个客户成功案例'], functionDef: '将客户成功案例转化为富有感染力的故事化叙述脚本。' },
    18: { id: 18, name: '账号定位', description: '输入个人信息快速生成账号名称与简介', fullDescription: '功能定义：为新账号快速生成奠定基础、明确调性的核心视频文案套装。\n使用场景：新账号冷启动阶段，快速发布首批定义账号价值的关键视频。\n核心价值：高效解决新账号"从0到1"的内容问题，快速完成账号定位传达。', inputGuide: '输入：你的网名或者姓名+你在哪里+你是做什么的+做了多少年+取得了什么成就等\n[您的行业]：\n[核心业务]：\n[最强成果]：\n[客户收益]：\n[行业情怀]：', welcomeMessage: '发送网名或者是姓名+行业+取得成就等，为你生成账号昵称及简介。示例：商机顾问、企业资源对接，帮助100+企业实现转型。', suggestedPrompts: ['我是吕总+北京+企业服务+20年', '帮我优化账号名称和简介', '生成我的个人定位文案'], functionDef: '为新账号快速生成昵称和简介，明确调性的新账号定位内容。' },
    19: { id: 19, name: 'IP 故事', description: '生成故事化IP视频脚本，深化用户信任', fullDescription: '功能定义：为创始人/老板生成用于打造个人IP的故事化视频脚本。\n使用场景：创作账号置顶视频，讲述创业初心、品牌故事，建立信任。\n核心价值：以人为本，情感连接，将老板打造成品牌最佳代言人，深化信任。', inputGuide: '通过多轮对话信息完整后生成', welcomeMessage: '输入“1”，按清单填写信息，生成逆袭故事文案。', suggestedPrompts: ['你开始吧', '帮我创作逆袭故事文案', '帮我创作一个创业逆袭故事'], functionDef: '生成用于打造个人 IP 的故事化视频脚本。' },
    20: { id: 20, name: '产品故事', description: '生成产品差异化价值的种草视频脚本', fullDescription: '功能定义：生成突出产品核心价值与差异化的故事化视频脚本。\n使用场景：创作账号第二条置顶视频，清晰传达产品为何值得选择。\n核心价值：让产品自己说话，聚焦价值而非功能，激发用户购买欲望。', inputGuide: '回复“1”：直接生成天九平台案例故事示例。\n回复“好的”或其它说明：通过多轮对话收集产品信息后，生成打动人心的产品故事脚本。', welcomeMessage: '回复“1”：查看天九平台产品故事示例；回复“好的”：多轮补充产品信息后生成产品故事脚本。', suggestedPrompts: ['1', '好的', '帮我创作产品故事文案'], functionDef: '生成突出产品核心价值与差异化的故事化视频脚本。' },
    21: { id: 21, name: '联系引导', description: '生成引导用户咨询下单的行动号召脚本', fullDescription: '功能定义：生成引导用户主动咨询、私信或下单的行动号召型视频脚本。\n使用场景：创作账号第三条置顶视频，明确告知用户下一步行动路径。\n核心价值：完成临门一脚，将流量高效转化为客资，形成获客闭环。', inputGuide: '输入"姓名+行业"格式的信息', welcomeMessage: '用“姓名 + 行业”格式发送，生成引导私信/咨询/下单的行动号召脚本。', suggestedPrompts: ['吕总 企业服务', '张总 教育培训', '帮我生成引导联系的文案'], functionDef: '生成引导用户主动咨询、私信或下单的行动号召型视频脚本。' },
    22: { id: 22, name: '直播脚本', description: '一键生成分钟级直播话术，赋能转化', fullDescription: '功能定义：生成详细到分钟的单场直播话术脚本，包括互动、讲解、逼单环节。\n使用场景：直播前，为主播/嘉宾提供标准化、高转化的话术流程。\n核心价值：稳定直播质量，避免冷场或遗漏卖点，最大化直播期间的销售转化。', inputGuide: '用户需提供以下信息：\n直播主题/标题\n产品名称及类别\n产品主要功能/特点(3-5点)\n产品价格/活动信息\n目标受众群体\n直播预计时长(默认60分钟)\n(可选)品牌调性关键词\n(可选)主播个人特点', welcomeMessage: '提供直播主题、产品、卖点、价格/活动、受众与时长等，生成带节奏的完整直播话术。', suggestedPrompts: ['1', '直播主题：企业转型分享', '帮我生成60分钟直播脚本'], functionDef: '生成详细到分钟的单场直播话术脚本，包括互动、讲解、逼单环节。' },
    23: { id: 23, name: '直播预热', description: '一键生成直播预告与推广引流文案', fullDescription: '功能定义：生成用于直播预告和直播付费推广的视频文案与素材创意。\n使用场景：直播开始前，制作引流视频，为直播间预热和拉流。\n核心价值：提升直播间的初始流量，解决"无人观看"的问题，放大直播效果。', inputGuide: '用户需提供以下基本信息：\n- 直播主题/标题\n- 目标客户群体(年龄、性别、兴趣等)\n- 直播时间\n- 直播主要内容/卖点(3-5点)\n- (可选)主播特点/风格\n- (可选)预期直播氛围\n- (可选)平台选择(抖音/视频号)', welcomeMessage: '提供直播主题、时间、目标人群、核心卖点与（可选）平台/氛围，生成预热短视频与投流文案。', suggestedPrompts: ['直播主题：企业转型专场', '帮我生成直播预热素材'], functionDef: '生成用于直播预告和引流推广的视频文案与素材创意。' },
    24: { id: 24, name: '朋友圈文案', description: '一键生成朋友圈营销文案，经营私域', fullDescription: '功能定义：生成适用于多种营销目的（人设打造、产品宣发、活动预热）的朋友圈文案。\n使用场景：每日经营微信朋友圈，持续输出价值内容，维护客户关系。\n核心价值：高效经营私域阵地，潜移默化地影响客户决策，提升品牌好感度。', inputGuide: '1. 自由输入模式：输入任意事件/感悟，自动生成高质量朋友圈\n2. 数字指令模式：输入数字调用结构化问答模板（默认含6大场景）\n   输入 1 → 生活圈模板（展现真实自我）\n   输入 2 → 价值圈模板（输出干货观点）\n   输入 3 → 产品圈模板（发布产品/活动）\n   输入 4 → 证言圈模板（展示客户好评）\n   输入 5 → 交付圈模板（呈现服务过程）\n   输入 6 → 成交圈模板（促进行动转化）\n   输入 0 → 查看所有模板指令', welcomeMessage: '「数字指令」生成符合天九营销场景的内容：\n🔸 输入 1 → 生活圈模板（展现真实自我）\n🔸 输入 2 → 价值圈模板（输出干货观点）\n🔸 输入 3 → 产品圈模板（发布产品 / 活动）\n🔸 输入 4 → 证言圈模板（展示客户好评）\n🔸 输入 5 → 交付圈模板（呈现服务过程）\n🔸 输入 6 → 成交圈模板（促进行动转化）\n也可直接用一句话描述事件/场景，生成朋友圈正文。', suggestedPrompts: ['今天拜访了一位老客户', '帮我写一条产品推广朋友圈'], functionDef: '生成适用于多种营销目的（人设打造、产品宣发、活动预热）的朋友圈文案。' },
    25: { id: 25, name: '私域话术', description: '按客户意向度一键生成精准私域话术', fullDescription: '功能定义：针对不同意向度的客户，生成精准的1对1沟通话术或社群发言内容。\n使用场景：对微信好友进行标签分类后，进行差异化的精准内容触达和互动。\n核心价值：实现"千人千面"的精准培育，在不同阶段提供最合适的内容，大幅提升转化率与复购率。', inputGuide: '你只需要告诉我，你的目标人群级别1-5号：\n级别1（已成交）：行动阶段，高成熟度。\n级别2（2年内参加活动未成交）：决策阶段，中高成熟度。\n级别3（5年内成交但最近2年未成交）：兴趣或决策阶段，但成熟度可能下降。\n级别4（线上关注有行为）：兴趣阶段，中低成熟度。\n级别5（仅有联系方式）：认知阶段，低成熟度。\n\n产品/服务类别， 核心卖点(3-5点)， 目标客户特征(年龄、职业、痛点等)。\n沟通场景(1对1聊天/社群互动)', welcomeMessage: '先回复“1～5”选择客户分级，再按提示补充产品/卖点与沟通场景（1 对 1 或社群）。\n【☀️客户分级说明】\n1=已成交客户（高成熟度・行动阶段）\n2=曾参会未成交客户（中高成熟度・决策阶段）\n3=历史成交近期未复购客户（成熟度下降・唤醒阶段）\n4=线上关注有互动行为客户（中低成熟度・兴趣阶段）\n5=仅有联系方式的新客户（低成熟度・认知阶段）', suggestedPrompts: ['级别2+企业服务+转型需求', '级别1+企业服务+成交后复购维护', '级别4+企业服务+激活线上关注用户'], functionDef: '针对不同意向度（如新添加、初步了解、深度兴趣、即将成交、已成交）的客户，生成精准的 1 对 1 沟通话术或社群发言内容。' },
    26: { id: 26, name: '批量文章', description: '一键生成公众号知乎深度长文内容', fullDescription: '功能定义：生成深度长文内容，适用于公众号，知乎等平台。\n使用场景：需要输出深度内容，建立专业权威，培育高价值用户。\n核心价值：以深度内容建立品牌壁垒，吸引和沉淀高质量用户，完成心智占领。', inputGuide: '用户需提供以下基本信息：\n- 文章主题/核心概念\n- (可选)目标受众群体\n- (可选)行业/领域\n- (可选)深度方向指引\n- (可选)品牌定位/调性\n- (可选)期望突出的专业角度', welcomeMessage: '提供文章主题或核心概念，可补充受众、行业、调性与希望强调的视角，生成公众号/知乎向深度长文。', suggestedPrompts: ['企业转型的5大误区', '如何打造企业第二增长曲线'], functionDef: '生成深度长文内容，适用于公众号、知乎等平台。' },
    27: { id: 27, name: '私域直播脚本', description: '一键生成私域专场直播完整话术脚本', fullDescription: '功能定义：生成详细到分钟的单场直播话术脚本，包括互动、讲解、逼单环节。\n使用场景：直播前，为主播/嘉宾提供标准化、高转化的话术流程。\n核心价值：稳定直播质量，避免冷场或遗漏卖点，最大化直播期间的销售转化。', inputGuide: '用户需提供以下基本信息：\n- 直播主题/产品名称\n- 直播目标(知识分享/产品介绍/问题解决/直接成交)\n- 目标受众特征(人群画像、痛点、需求)\n- 产品/服务核心卖点(3-5点)\n- 价格/活动方案\n- (可选)常见疑虑/反对点\n- (可选)直播预计时长(默认60分钟)\n- (可选)主播风格/特点', welcomeMessage: '提供直播主题、目标、人群、卖点、价格活动与时长等，生成私域/沙龙专场完整话术脚本。', suggestedPrompts: ['主题：企业合作模式专场', '帮我生成90分钟私域直播稿'], functionDef: '生成适用于私域进行的专场直播 / 沙龙分享话术脚本。' },
    28: { id: 28, name: '直播跟单话术', description: '一键生成业务员跟单互动话术库', fullDescription: '功能定义：生成私域直播过程中，业务员在群内互动、答疑、烘托气氛、实时跟单的话术。\n使用场景：私域直播中，配合主播进行氛围营造和促单，应对客户各种问题。\n核心价值：形成团队协作，多对一服务，营造抢购氛围，提升直播成交率。', inputGuide: '用户需提供以下基本信息：\n- 直播主题/产品名称\n- 产品核心卖点(3-5点)\n- 直播特殊活动/优惠\n- 产品价格区间\n- 目标客户特征\n- (可选)主要竞品/替代方案\n- (可选)常见问题/顾虑\n- (可选)业务员人数\n- (可选)主播风格特点', welcomeMessage: '提供直播产品、卖点、优惠、价位、人群与常见顾虑等，生成群内跟单、起哄、答疑话术库。', suggestedPrompts: ['直播主题：企业资源共享', '帮我生成跟单话术库'], functionDef: '生成私域直播过程中，业务员在群内互动、答疑、烘托气氛、实时跟单的话术。' },
    29: { id: 29, name: '大会销讲话术', description: '一键生成有感染力的招商演讲稿', fullDescription: '功能定义：为会议主讲人生成结构完整、富有感染力的招商演讲或产品发布稿。\n使用场景：筹备招商会、产品发布会、大型培训会等活动的讲师讲稿。\n核心价值：确保会议核心内容专业、流畅，有效影响听众决策，提升现场氛围。', inputGuide: '用户需提供以下基本信息：\n- 会议主题或产品名称\n- 目标受众(身份、背景、需求)\n- 核心卖点(3-5点)\n- 合作模式/价格方案\n- 演讲时长(默认45-90分钟)\n- (可选)行业背景/市场现状\n- (可选)讲师背景/风格偏好\n- (可选)预期达成目标\n- (可选)常见抵触点/顾虑', welcomeMessage: '提供会议主题、受众、卖点、合作/价格方案与演讲时长等，生成招商或发布类销讲话术稿。', suggestedPrompts: ['招商会：企业转型专场', '帮我生成60分钟演讲稿'], functionDef: '为会议主讲人生成结构完整、富有感染力的招商演讲或产品发布稿。' },
    30: { id: 30, name: '会议流程策划', description: '一键生成会议全流程执行方案', fullDescription: '功能定义：生成会议全流程执行方案，包括会前、会中、会后各环节的运营细节。\n使用场景：会议总策划人员统筹安排会议全流程执行工作。\n核心价值：确保会议井井有条，环节之间无缝衔接，提供卓越的参会体验。', inputGuide: '用户需提供以下基本信息：\n- 会议主题/招商项目名称\n- 会议规模(预计参会人数)\n- 会议时长与形式(线上/线下/混合)\n- 目标受众群体\n- 预期招商目标\n- (可选)会议地点/平台\n- (可选)主讲人信息\n- (可选)特殊要求或环节\n- (可选)预算范围', welcomeMessage: '提供会议主题、规模、形式、目标受众与关键日程约束，生成会前-会中-会后全流程策划。', suggestedPrompts: ['100人线下招商会，企业转型主题，半天', '帮我策划一场招商会流程'], functionDef: '生成会议全流程执行方案，包括会前、会中、会后各环节的运营细节。' },
    31: { id: 31, name: '会销客户沟通话术', description: '生成会议期间客户群同步投喂话术', fullDescription: '功能定义：生成会议期间，业务员在客户群内同步内容、互动、答疑、促单的话术。\n使用场景：线下会议期间，在线上客户群内进行同步运营，强化现场氛围。\n核心价值：线上线下联动，放大会议影响力，覆盖更多客户，提升整体签约率。', inputGuide: '用户需提供以下基本信息：\n- 会议主题/招商项目名称\n- 会议流程与时间安排\n- 主讲核心内容要点(3-5点)\n- 合作模式/产品核心卖点\n- 目标客户群体特征\n- (可选)现场特殊活动/优惠\n- (可选)群内成员构成特点\n- (可选)常见问题与顾虑\n- (可选)群投喂节奏偏好', welcomeMessage: '提供会议主题、流程节点、主讲要点、产品与受众等，生成会中客户群同步投喂话术。', suggestedPrompts: ['企业转型招商会，目标当场成交', '帮我生成社群投喂话术'], functionDef: '生成会议期间，业务员在客户群内同步内容、互动、答疑、促单的话术。' },
    32: { id: 32, name: '个人IP起号视频文案（教育创业者）', description: '为教育创业者定制个人IP起号文案', fullDescription: '功能定义：为教育创业者生成个人IP起号视频文案。', inputGuide: '基本信息：\n- 身份定位：\n- 转变历程：\n- 时间跨度：\n- 核心成果：', welcomeMessage: '填写身份定位、转变历程、时间跨度与核心成果，生成教育创业者向个人 IP 起号视频文案。', suggestedPrompts: ['身份：教育培训创始人，从传统教培转型AI教育，历时3年', '我是从传统教培转型AI', '帮我生成起号文案'] },
...
function renderSidebar() {
    ...
    for (const [categoryName, agents] of Object.entries(agentsData)) {
        ...
        agents.forEach(agent => {
            ...
            agentItem.innerHTML = '<span class="agent-item-icon" aria-hidden="true">' + getIconSVG(sideIcon, 16) + '</span><span class="agent-item-name">' + agent.name + (agentHasRecBadge(agent.id) ? '<span class="agent-rec-badge">推荐</span>' : '') + '</span>';
...
/**
 * 行首是否为 ATX 标题（##～######）。模型常省略 # 后空格，如 ###本次、###①。
 */
function lineLooksLikeAtxHeading(l) {
    if (!l) return false;
    var t = String(l).replace(/^\uFEFF/, '').replace(/[\u200B-\u200D\uFEFF]/g, '').trim();
    // 至少 2 个 #，且后面还有内容（空格、全角空格、标题字均可）
    return /^#{2,6}./.test(t);
}

/**
 * 判断是否「大字报短句体」：大量 ≤14 字短行 + hashtag 行，且长句少。
 * 此类内容换行本身就是排版，禁止做任何行合并。
 */
function looksLikePosterShortLines(lines) {
    if (!lines || lines.length < 6) return false;
    var nonEmpty = lines.filter(function(l) { return l && l.trim(); }).map(function(l) { return l.trim(); });
    if (nonEmpty.length < 6) return false;
    // 含 Markdown 标题行：必须走 Markdown，不能用 pre 原样输出（含 > ### 这种引用内标题）
    if (nonEmpty.some(function(l) {
        return lineLooksLikeAtxHeading(l) || lineLooksLikeAtxHeading(l.replace(/^\s*>\s*/, ''));
    })) return false;
    // 多行以 > 开头的引用块（直播预热等）：结构化文案，走 Markdown
    var blockquoteLines = 0;
    for (var b = 0; b < nonEmpty.length; b++) {
        if (/^>/.test(nonEmpty[b])) blockquoteLines++;
    }
    if (blockquoteLines >= 2) return false;
    var shortCount = 0, hashCount = 0, punctEnd = 0;
    for (var i = 0; i < nonEmpty.length; i++) {
        var l = nonEmpty[i];
        if (l.length <= 16) shortCount++;
        if (/^#[^\s#]/.test(l) || /\s#[^\s#]/.test(l)) hashCount++;
        if (/[。！？.!?]$/.test(l)) punctEnd++;
    }
    var shortRatio = shortCount / nonEmpty.length;
    var punctRatio = punctEnd / nonEmpty.length;
    return (shortRatio >= 0.60 && punctRatio <= 0.40) || (hashCount >= 2 && shortRatio >= 0.45);
}

/**
 * 是否像「多行列表」正文（有序/无序）。
 */
function looksLikeStructuredList(text) {
    if (!text || typeof text !== 'string') return false;
    var lines = text.split('\n');
    var ord = 0, bull = 0;
    for (var i = 0; i < lines.length; i++) {
        var line = lines[i];
        if (/^\s*\d{1,3}[\.\/、．]\s/.test(line)) ord++;
        else if (/^\s*[-*]\s/.test(line)) bull++;
        if (ord >= 2 || bull >= 2) return true;
    }
    return false;
}

/**
 * 周选题 / 多日排期类长文：多天日期、多段「早/午/晚」结构，词汇在头尾会自然重复。
 * 若仍走 tryDedupeBySingleNewline，会被误判为「重复碎片+一段正文」而只保留末尾一天，造成内容残缺。
 */
function looksLikeWeekOrMultiDayTopicPlan(text) {
    if (!text || typeof text !== 'string' || text.length < 120) return false;
    var dateLabels = text.match(/\d{1,2}月\d{1,2}日/g);
    if (dateLabels && dateLabels.length >= 2) return true;
    var zaoWuWan = (text.match(/[早晚午]（[^）]{2,8}）/g) || []).length;
    if (zaoWuWan >= 4) return true;
    if ((text.match(/机器编号\s*[:：]/g) || []).length >= 2) return true;
    if (/选题.*周|一周.*选题|内容选题|排期|日历/i.test(text) && text.length > 400) return true;
    return false;
}

/**
 * 渲染助手消息为 HTML。
 * 核心策略：在任何归一化/Markdown解析之前先做大字报检测；
 * 大字报体直接 pre-wrap 保留换行；其余走 Markdown 解析。
 */
function renderAssistantContentHTML(raw) {
    var s = String(raw || '');
    // 仅做最基础清理（不改行结构）
    var basic = s
        .replace(/\r\n/g, '\n')
        .replace(/[\u0334-\u0338\u20E5\u20E6]/g, '')  // 去组合删除线字符
        .replace(/~~([\s\S]*?)~~/g, '$1')              // 去 GFM ~~删除线~~ 语法，只保留文字
        .replace(/\n{3,}/g, '\n\n')
        .trim();
    var basicLines = basic.split('\n').map(function(l) { return l.trim(); });
    if (looksLikePosterShortLines(basicLines)) {
        // 大字报：pre-wrap 原样渲染，不走 Markdown
        return '<pre class="assistant-poster">' + escapeHtml(basic) + '</pre>';
    }
    return parseAssistantMarkdown(s);
}
...
function sanitizeMarkdownInput(raw) {
    ...
    // 清理「组合删除线/叠加线」字符
    s = s.replace(/[\u0334-\u0338\u20E5\u20E6]/g, '');
    // 去掉 GFM ~~删除线~~ 语法（只保留文字内容，不允许任何删除线出现）
    s = s.replace(/~~([\s\S]*?)~~/g, '$1');
    // 连续 3 个及以上换行压成 2 个（仅保留段落间一空行）
    s = s.replace(/\n{3,}/g, '\n\n');
    // 避免标点符号被单独拆成一段（如 \n\n，...）
    s = s.replace(/\n{2,}([，,。.!?？；;：:])/g, '$1');
    // 行首「数字+点+紧跟正文」补空格，便于 GFM 识别为有序列表
    s = s.replace(/^(\s*)(\d{1,3})([\.\/、．])(?=[\u4e00-\u9fa5A-Za-z（【])/gm, '$1$2$3 ');
    // breaks:false 模式下，同段落内单个换行被视为空格，会导致相邻「**标签**：」行被合并成一行。
    // 解决：在行首 ** 粗体标签行（紧跟 : 或 ：）前后各补一个空行，强制分成独立段落。
    s = s.replace(/([^\n])\n(\*\*[^*\n]+\*\*\s*[：:])/g, '$1\n\n$2');
    s = s.replace(/(\*\*[^*\n]+\*\*\s*[：:][^\n]*)\n([^\n*#\-> ])/g, '$1\n\n$2');
    // 再次压缩多余空行
    s = s.replace(/\n{3,}/g, '\n\n');
...
function parseAssistantMarkdown(raw) {
    ...
    try {
        ...
        // 最后防线：清除任何残留的 <del>/<s>/<strike> 删除线标签，保留内部文字
...
/** 根据当前消息列表同步侧边栏用的 agentHistory（最后一条助手输出） */
function syncAgentHistoryOutput(agentId) {
    var list = agentChatMessages[agentId];
    if (!list || list.length === 0) {
        delete agentHistory[agentId];
        return;
    }
    var lastOut = null;
    for (var i = list.length - 1; i >= 0; i--) {
        if (list[i].role === 'assistant') {
            lastOut = list[i].content;
            break;
        }
    }
    if (lastOut != null) agentHistory[agentId] = { output: lastOut };
    else delete agentHistory[agentId];
}

/** 单条消息：复制原文（Markdown 纯文本） */
function copyMessageAt(agentId, index) {
    var list = agentChatMessages[agentId];
    if (!list || !list[index]) {
        showToast('无法复制', 'error');
        return;
    }
    var text = list[index].content || '';
...
/** 结束流式打字机并恢复输入区（删除消息时避免定时器操作已卸载的节点） */
function stopStreamingUiIfNeeded() {
    if (streamingTimerId) {
...
/** 单条消息：从当前会话中删除 */
function deleteMessageAt(agentId, index) {
    var list = agentChatMessages[agentId];
    if (!list || index < 0 || index >= list.length) return;
    if (streamingTimerId) stopStreamingUiIfNeeded();
    list.splice(index, 1);
    syncAgentHistoryOutput(agentId);
    renderChatMessages(agentId);
    renderSidebar();
    showToast('已删除', 'success');
}

var MSG_TOOLBAR_SVG_COPY = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/></svg>';
var MSG_TOOLBAR_SVG_TRASH = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg>';

function appendMsgToolbar(stack, toolbar) {
    if (!toolbar || toolbar.agentId == null || toolbar.index == null) return;
    var aid = toolbar.agentId;
    var idx = toolbar.index;
    ...
    copyBtn.innerHTML = MSG_TOOLBAR_SVG_COPY;
    copyBtn.onclick = function (e) {
        e.stopPropagation();
        copyMessageAt(aid, idx);
    };
    var delBtn = document.createElement('button');
    delBtn.type = 'button';
    delBtn.className = 'msg-tool-btn';
    delBtn.title = '删除';
    delBtn.setAttribute('aria-label', '删除此条消息');
    delBtn.innerHTML = MSG_TOOLBAR_SVG_TRASH;
    delBtn.onclick = function (e) {
        e.stopPropagation();
        deleteMessageAt(aid, idx);
    };
...
// 创建消息行：AI消息带小头像 + 气泡下复制/删除；用户消息仅气泡（无工具条）
function createMsgRow(role, iconName, toolbar) {
    if (role === 'assistant') {
        ...
        appendMsgToolbar(stack, toolbar);
        row.appendChild(avatar);
        row.appendChild(stack);
        return { row: row, bubble: bubble };
    }
    var rowU = document.createElement('div');
    rowU.className = 'msg-row msg-row-user';
    var bubbleU = document.createElement('div');
    bubbleU.className = 'chat-message user';
    rowU.appendChild(bubbleU);
    return { row: rowU, bubble: bubbleU };
}
...
function renderChatMessages(agentId) {
    ...
    try {
        ...
        if (welcomeEl) {
            var welcome = (agent && agent.welcomeMessage)
                ...
                : (agent && agent.inputGuide
                    ? '请根据下方提示输入内容，或直接描述你的需求后发送。'
                    : '请直接输入需求，按发送或 Enter 提交。');
        ...
        list.forEach(function (msg, idx) {
            var item = createMsgRow(msg.role, msgIcon, { agentId: agentId, index: idx });
            if (msg.role === 'assistant' && typeof marked !== 'undefined') {
                item.bubble.innerHTML = '<div class="markdown-body">' + renderAssistantContentHTML(msg.content || '') + '</div>';
            } else {
...
/** 切换智能体或中断流式时：取消定时器，避免旧会话的打字机改写当前界面 */
function cancelActiveStreamingAndResetUI() {
    if (streamingTimerId) {
        clearInterval(streamingTimerId);
        streamingTimerId = null;
    }
...
/** 异步返回时若用户已切到其他智能体，只刷新当前可见会话，避免把回复画错窗口 */
function renderChatMessagesAfterAsync(fromAgentId) {
    if (currentAgent && currentAgent.id === fromAgentId) {
        renderChatMessages(fromAgentId);
    } else if (currentAgent && currentAgent.id) {
...
function renderWithStreamingEffect(agentId, fullContent, onDone) {
    ...
    for (var i = 0; i < list.length - 1; i++) {
        var msg = list[i];
        var item = createMsgRow(msg.role, streamIcon, { agentId: agentId, index: i });
        if (msg.role === 'assistant' && typeof marked !== 'undefined') {
            item.bubble.innerHTML = '<div class="markdown-body">' + renderAssistantContentHTML(msg.content || '') + '</div>';
        } else {
            item.bubble.textContent = msg.content || '';
    ...
    var streamItem = createMsgRow('assistant', streamIcon, { agentId: agentId, index: list.length - 1 });
    ...
    function tick() {
        if (streamingStopRequested || pos >= fullContent.length) {
            clearInterval(streamingTimerId);
            streamingTimerId = null;
            inner.innerHTML = renderAssistantContentHTML(fullContent);
            if (stopWrap) stopWrap.style.display = 'none';
            if (submitBtn) submitBtn.disabled = false;
            if (loadingEl) loadingEl.classList.remove('active');
            container.scrollTop = container.scrollHeight;
        ...
        // 切换智能体后 currentAgent 已变，不再向当前 DOM 续写，避免错位
...
function switchAgent(agent, saveCurrent) {
    ...
    cancelActiveStreamingAndResetUI();
    currentAgent = agent;
...
function dedupeAssistantOutput(text) {
    ...
    var s = text.trim();
    s = s.replace(/^[.，、；：\s]+/, '');
    // 大字报/短句体：多节内容本身词汇高度相似，去重逻辑会误判为"重复"，直接跳过
    var _preLines = s.split('\n').map(function(l){ return l.trim(); });
    if (looksLikePosterShortLines(_preLines)) return s;
    // 七天选题、多日排期：禁止去重，否则常只保留最后一天
    if (looksLikeWeekOrMultiDayTopicPlan(s)) return s;
    if (looksLikeStructuredList(s)) return s;
...
function doSendMessage(userInput) {
    ...
    .then(function (response) {
        if (!response.ok) {
            ...
            // 兼容：网关可能返回 HTML；优先尝试解析后端 JSON message，便于定位 500/502/504 根因
            return response.text().then(function (text) {
                var serverMsg = '';
                try {
                    var parsed = JSON.parse(text || '{}');
                    if (parsed && parsed.message) serverMsg = String(parsed.message);
                } catch (e) {}
                var friendlyMsg =
                    status === 504 ? 'AI 响应超时（504），请稍后重试' :
                    status === 502 ? '服务暂时不可用（502），请稍后重试' :
                    status === 503 ? '服务暂时不可用（503），请稍后重试' :
                    ('请求失败（' + status + '），请稍后重试');
                if (serverMsg) friendlyMsg = friendlyMsg + '：' + serverMsg;
        ...
        if (data.success && data.data) {
            ...
            if (outputContent && outputContent.indexOf('响应数据格式异常') === -1) {
                ...
                if (currentAgent && currentAgent.id === id) {
                    ...
                    renderSidebar();
                    renderChatMessagesAfterAsync(id);
                    var doneAgent = allAgentsMap[id] || allAgents.find(function (a) { return a.id === id; });
                    if (doneAgent && doneAgent.name) {
                        showToast('「' + doneAgent.name + '」已生成回复，可切换查看', 'success');
                    }
                }
                return;
            }
    ...
    .catch(function (err) {
        ...
        var tip, msg;
        if (!navigator.onLine || raw.indexOf('ERR_INTERNET_DISCONNECTED') !== -1 || raw.indexOf('NetworkError') !== -1) {
            tip = '网络已断开，请检查网络后重试';
            msg = '网络已断开，请检查网络连接后重新发送';
        } else if (raw === 'Failed to fetch' || raw.indexOf('fetch') !== -1 || raw.indexOf('ERR_CONNECTION') !== -1) {
            tip = '无法连接服务，请稍后重试';
            msg = '无法连接服务器，请稍后重试';
        } else if (raw.indexOf('timeout') !== -1 || raw.indexOf('超时') !== -1) {
            tip = 'AI 响应超时，请稍后重试';
            msg = '请求超时，AI 处理时间过长，请稍后重试';
        } else {
            tip = '请求失败，请稍后重试';
            msg = raw || '请求失败，请稍后重试';
        }
...
function renderHotRecommendations() {
    ...
    hotRecommendedAgentIds.forEach(function(agentId, idx) {
        ...
        card.innerHTML =
            ...
            '</div>' +
            '<div class="hot-agent-name">' + agent.name + (agentHasRecBadge(agent.id) ? '<span class="agent-rec-badge">推荐</span>' : '') + '</div>' +
            ...
            agentCard.innerHTML =
                ...
                '<div class="agent-card-content">' +
                    '<div class="agent-card-header">' +
                        '<div class="agent-card-name">' + agent.name + (agentHasRecBadge(agent.id) ? '<span class="agent-rec-badge">推荐</span>' : '') + '</div>' +
...
function initializePage() {
    if (typeof marked !== 'undefined') {
        ...
        if (typeof marked.use === 'function') {
            // 覆盖 del renderer：禁止任何删除线渲染，直接输出内部文字（marked v11 用 parseInline）
            marked.use({
                gfm: true,
                breaks: false,
                renderer: {
                    del: function(token) {
                        // marked v9+ 传 token 对象，token.tokens 是内部 inline token 数组
